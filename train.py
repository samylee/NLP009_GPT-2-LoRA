...
parser.add_argument('--random_seed', type=int, default=110, help='gradient accumulation steps')

parser.add_argument('--device', type=int, default=0, help='gradient accumulation steps')

parser.add_argument('--train_data', type=str, default='data/train_encode.jsonl', help='location of training data corpus')

parser.add_argument('--valid_data', type=str, default='data/valid_encode.jsonl', help='location of validation data corpus')
...
parser.add_argument('--work_dir', type=str, default='./trained_models/GPT2_S/e2e',
                    help='working folder.')
...
if __name__ == '__main__':
    ...
    if args.max_step is None:
        args.max_step = args.max_epoch * train_data.num_batches - 1
